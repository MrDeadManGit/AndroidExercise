...
public class MyItemAnimator extends SimpleItemAnimator {
    ...
    public MyItemAnimator(int animDuration, int colCount) {
        customDuration = animDuration;
        this.colCount = colCount;
    }

    public void setDeletePosition(int pos) {
        deletePosition = pos;
        moveCounter = deletePosition;
        changeCounter = deletePosition;
    }
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (movesPending) {
                ...
                adder = new Runnable() {
                    public void run() {
                        ...
                        MyItemAnimator.this.mMovesList.remove(finalAdditions);
                    }
                };
                if (removalsPending) {
            ...
            if (changesPending) {
                ...
                adder = new Runnable() {
                    public void run() {
                        ...
                        MyItemAnimator.this.mChangesList.remove(finalAdditions1);
                    }
                };
                if (removalsPending) {
            ...
            if (additionsPending) {
                ...
                if (!removalsPending && !movesPending && !changesPending) {
                    ...
                    long removeDuration = removalsPending ? 0 : 0L;
                    long moveDuration = movesPending ? customDuration : 0L;
                    long changeDuration = changesPending ? customDuration : 0L;
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(0).alpha(0.0F).setListener(new AnimatorListenerAdapter() {
    ...
    void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(1.0F).setDuration(customDuration).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
    ...
    void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
      ...
      /*  int delay = ((moveCounter / colCount) - (deletePosition / colCount)) * customDuration;
        moveCounter++;

        animation.setStartDelay(delay);*/

        animation.setDuration(customDuration).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
    ...
    void animateChangeImpl(final MyItemAnimator.ChangeInfo changeInfo) {
        ...
        if (view != null) {
            newViewAnimation = view.animate().setDuration(customDuration);
...
/*
            int delay = ((changeCounter / colCount) - (deletePosition / colCount)) * customDuration;
            changeCounter++;

            newViewAnimation.setStartDelay(delay);*/

            final ViewPropertyAnimator finalNewViewAnimation = newViewAnimation;
            newViewAnimation.alpha(1F).setListener(new AnimatorListenerAdapter() {
                public void onAnimationStart(Animator animator) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0F).translationY(0.0F).setDuration(customDuration).alpha(1.0F).setListener(new AnimatorListenerAdapter() {
                public void onAnimationStart(Animator animator) {
